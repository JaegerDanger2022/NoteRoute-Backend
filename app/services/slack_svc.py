...
def _fetch_channel_messages_sync(channel_id: str, access_token: str, max_chars: int = 50000) -> str:
...
async def fetch_channel_messages(channel_id: str, access_token: str, max_chars: int = 50000) -> str:
